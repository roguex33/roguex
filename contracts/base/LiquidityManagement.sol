...
/// @notice Internal functions for safely managing liquidity in Position Pool
abstract contract LiquidityManagement is IMintCallback, PeripheryImmutableState, PeripheryPayments {
        ...
        )
    {
        ...
        pool = IRoxSpotPool(IRoguexFactory(factory).getPool(params.token0, params.token1, params.fee));
