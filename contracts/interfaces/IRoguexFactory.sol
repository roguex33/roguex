...
/// @title The interface for the IRoguexFactory
/// @notice The IRoguexFactory facilitates creation of roguex pools and control over the protocol fees
interface IRoguexFactory {
    ...
    function approvedPerpRouters(address router) external view returns (bool);
    function approvedSpotRouters(address router) external view returns (bool);
    function approvedPerpPool(address router) external view returns (bool);
    function approvedSpotPool(address router) external view returns (bool);
