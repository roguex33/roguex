...
contract Quoter is IQuoter, ISwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IRoxSpotPool) {
        return
            IRoxSpotPool(IRoguexFactory(factory).getPool(tokenA, tokenB, fee));
    }
