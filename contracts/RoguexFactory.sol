...
contract RoguexFactory is IRoguexFactory, NoDelegateCall {
    ...
    uint256 public override perpThres = 500; // Default 80%, open position be paused when perpResv / Liq.Total > perpThres
    uint256 public override setlThres = 700; // Default 80%,  when perpResv / Liq.Total > perpThres
    ...
    function setUtils(address _rUtils) external onlyOwner{
        utils = _rUtils;
    }
